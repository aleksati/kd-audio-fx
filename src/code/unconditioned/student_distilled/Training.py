...
def LSTM_KD_distilled_student(**kwargs):
    ...
    model = create_model_LSTM_DK2(
        input_dim=input_dim, mini_batch_size=mini_batch_size, units=units,
    ...
    if not inference:
        ...
        test_gen = DataGeneratorPicklesTrain(data_dir, dataset_train + '_test.pickle', mini_batch_size=mini_batch_size,
                                         input_size=input_dim, batch_size=batch_size)
    ...
    model = create_model_LSTM_DK2(
        input_dim=input_dim, mini_batch_size=mini_batch_size, units=units,
        b_size=1, stateful=True, training=False)
