...
def parse_args():
    ...
    parser.add_argument('--model_save_dir', default='../../../models/students_distilled', type=str, nargs='?', help='Folder directory in which to store the model and all other results (loss)')
