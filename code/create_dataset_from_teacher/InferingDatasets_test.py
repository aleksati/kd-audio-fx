...
def trainDK1(**kwargs):
    ...
    # create the model
    #model = create_model_LSTM_DK_morelay(input_dim=input_dim, mini_batch_size=mini_batch_size, b_size=1, stateful=True)
    ...
    train_gen = DataGeneratorPickles(data_dir, dataset + '_test.pickle', mini_batch_size=mini_batch_size, input_size=input_dim, batch_size=1)
