...
def create_model_LSTM_DK1(input_dim=1, conditioning_size=1, b_size=2400):
    ...
    outputs = tf.keras.layers.LSTM(32, stateful=True, return_sequences=True, name='LSTM2')(outputs)
    ...
    outputs = tf.keras.layers.LSTM(8, stateful=True, return_sequences=False, name="LSTM4")(outputs)
...
def __create_model_LSTM_DK1(input_dim=1, conditioning_size=1, b_size=2399):
